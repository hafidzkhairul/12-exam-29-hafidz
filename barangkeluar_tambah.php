...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1 class="h3 mb-0 text-gray-800">
      Barang Keluar
      <small>Tambah Barang Keluar Baru</small>
    </h1>
      ...
      <section class="container-fluid">       
        <div class="card shadow mb-4">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
              ...
              <h6 class="h3 mb-0 font-weight-bold text-primary">Tambah Barang Keluar Baru</h6>
          ...
          <div class="card-body">
            <form action="barangkeluar_act.php" method="post">
              
              <div class="form-group">
                <label>Tanggal Keluar</label>
                <input type="date" class="form-control" name="tgl_keluar" required="required" placeholder="Masukkan tanggal ..">
              </div>
